...
|---|---|---|---|
| dev | `yswords-dev`, `yswords-cn-dev` | **1.4.128** | push freely |
| qat | `yswords-qat`, `yswords-cn-qat` | **1.4.128** | push freely once dev is verified |
| prod | `yswords`, `yswords-cn` | **1.4.11** | ⛔ never without explicit permission **in the current turn** |

**prod is 117 versions behind and it is not an oversight.** Every prod
