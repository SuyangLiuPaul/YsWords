...
void main() {
  ...
  const repaired = <String, List<String>>{
    ...
    '040015034': ['多少饼？”他们说：“有七个', '多少餅？」他們説：「有七個'],
    '040017026': ['是向外人。”耶稣说：“既然如此', '是向外人。」耶穌説：「既然如此'],
    '041006037': ['他们吃吧。”门徒说：“我们可以', '他們吃吧。」門徒説：「我們可以'],
    '043002007': ['倒满了水。”他们就倒满了', '倒滿了水。」他們就倒滿了'],
    '043002008': ['管筵席的。”他们就送了去。', '管筵席的。」他們就送了去。'],
    '043013029': ['应用的东西”，或是叫他', '應用的東西」，或是叫他'],
    '043013036': ['那里去？”耶稣回答说：“我所去', '那裏去？」耶穌回答説：「我所去'],
  ...
  test('not one Chinese character moved — only quotation marks', () {
    ...
    const expectedHant = <String, String>{
      '001030006': '拉結説：神伸了我的冤，也聽了我的聲音，賜我一個兒子，因此給他'
          '起名叫但。',
      '040015034': '耶穌説：你們有多少餅？他們説：有七個，還有幾條小魚。',
      '041006037': '耶穌回答説：你們給他們吃吧。門徒説：我們可以去買二十兩銀子的'
          '餅，給他們吃嗎？',
      '043002007': '耶穌對用人説：把缸倒滿了水。他們就倒滿了，直到缸口。',
      '043002008': '耶穌又説：現在可以舀出來，送給管筵席的。他們就送了去。',
      ...
      // they are untouched.
      '043013036': '西門彼得問耶穌説：主[耶穌]往那裏去？耶穌回答説：我所去的地方，你'
          '現在不能跟我去，後來卻要跟我去。',
    };
