...
void main() {
  ...
  const restored = <String, List<String>>{
    ...
    '001045015': ['随后他弟兄们就和他说话', '隨後他弟兄們就和他説話'],
    '001050011': ['一场极大的哀哭', '一場極大的哀哭'],
    // 繁體 稭, not 秸, since 2026-09-18 (Raymond 牧師's principle).
    '002015007': ['像烧碎秸一样', '像燒碎稭一樣'],
  ...
  test('the repair inserted characters and replaced nothing', () {
    ...
    expect(zhHant['058002002'], contains('那藉着天使所傳的話既是確定的；凡干犯悖逆的'));
  });
}
