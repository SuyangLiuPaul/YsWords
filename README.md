...
| Reader — paragraph flow with section titles + "About this book"                                          | Immersive reading — chrome auto-hides, mini-header stays                                                |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| <img src="assets/screenshots/screenshot_reading_paragraph.png" alt="Reader — paragraph mode" height="320"/> | <img src="assets/screenshots/screenshot_reading_immersive.png" alt="Immersive reading" height="320"/> |

| AI study panel — confirm-first, optional question box                                              | AI study chat — explanation + 更简短/更详细 + save-to-note + follow-up                                 |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| <img src="assets/screenshots/screenshot_ai_panel.png" alt="AI study panel" height="320"/>          | <img src="assets/screenshots/screenshot_ai_explanation.png" alt="AI explanation" height="320"/>       |

| Verse selection bar — copy · share · cross-refs · exegesis · AI · note · bookmark · highlight        | Version switcher — all 14 EN/中文 translations                                                          |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| <img src="assets/screenshots/screenshot_multi_select.png" alt="Verse selection bar" height="320"/>   | <img src="assets/screenshots/screenshot_version_switch.png" alt="Version switcher" height="320"/>      |

| Book picker — Hebrew / Greek tabs + book grid                                                            | Search — word / reference / Strong's number / Greek-Hebrew                                             |
| -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| <img src="assets/screenshots/screenshot_book_chapter_picker.png" alt="Book picker" height="320"/>        | <img src="assets/screenshots/screenshot_search.png" alt="Search" height="320"/>                        |

| Settings — account, font / menu / line-spacing                                                  | Theme — primary-colour palette + Theme Mode + Reading Mode                                             |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| <img src="assets/screenshots/screenshot_settings_page.png" alt="Settings" height="320"/>        | <img src="assets/screenshots/screenshot_settings_theme.png" alt="Theme settings" height="320"/>        |

| Dark mode — reader                                                                              | Dark mode — dashboard                                                                                  |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| <img src="assets/screenshots/screenshot_dark_mode.png" alt="Dark mode reader" height="320"/>    | <img src="assets/screenshots/screenshot_dark_dashboard.png" alt="Dark mode dashboard" height="320"/>   |
