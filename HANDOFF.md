...
> Last updated: 2026-05-24 — **v1.2.95 → v1.3.9 — PageView root-cause refactor, themed iOS/Android/macOS/web app icons, per-category notification scheduler, daily-verse rotation fix, comprehensive perf sweep, navigation dedup, tooling.**
>
