...
import 'package:yahwehs_words/widgets/cloud_setup_diagnostic.dart';
...
import 'package:yahwehs_words/widgets/setup_instructions_card.dart';
...
class _AppLicenseCard extends StatelessWidget {
  ...
  Future<void> _openRepo(BuildContext context) async {
    ...
    await LinkOpener.openOrWarn(
        context, 'https://github.com/SuyangLiuPaul/Yahwehs-Words');
  }
