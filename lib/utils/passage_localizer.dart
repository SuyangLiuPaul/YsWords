...
final RegExp passageRefPattern = RegExp(
  ...
  r'阿摩司书|俄巴底亚书|约拿书|约拿记|弥迦书|那鸿书|哈巴谷书|西番雅书|'
  r'哈该书|撒迦利亚书|玛拉基书|'
  // New Testament — Simplified
  r'马太福音|马可福音|路加福音|约翰福音|使徒行传|罗马书|'
  r'哥林多前书|哥林多后书|加拉太书|以弗所书|腓立比书|歌罗西书|哥罗西书|'
  ...
  r'阿摩司書|俄巴底亞書|約拿書|約拿記|彌迦書|那鴻書|哈巴谷書|西番雅書|'
  r'哈該書|撒迦利亞書|瑪拉基書|'
  // New Testament — Traditional
  r'馬太福音|馬可福音|路加福音|約翰福音|使徒行傳|羅馬書|'
  r'哥林多前書|哥林多後書|加拉太書|以弗所書|腓立比書|歌羅西書|哥羅西書|'
