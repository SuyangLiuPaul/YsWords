...
const String kCuvSimplifiedChars =
    '䍁万与丑专业丛东丝丢两严丧个丰临为丽举么义乌乐习乡书买乱了争于亏云亘亚产亩亲亵亿仅仆从仑仓仪们价仿众'
    '伙会伟传伤伦伪体余佛佣侄侧借债倾偿儿克党兰关兴养兽内冈册写军农冲冲决况净凄凄准凉减凑几凤凭凯凶击凿划'
    '则刚创删别刮制剑剥劝办务动励劲劳势匀区医华协单卖占卤卫却卷厂厅历厉压厌厕厨参双发发变叙叠只台叶号叹叹'
    '吁合吊后吓吕吗听启吴呐呕员周咙咸响哑哒哗唤啬喂喷嗳嘘嘱回团园围囵国图圆圣场坏块坚坛坛坟坠垒垦垫堕墙壮'
    '声壶处备复复复够头夸夹夺奁奋奖奥奸妆妇妈娇娈婴嫔孙学宁宝实宠审宫宽宾寝对寻导寿将尔尘尝尸尽尽层屉属屡'
    '岁岂岖岛岩岭峰布帅师帐帘帜带帮干干并并广庄庆床库应庙废廪开异弃弑张弥弯弹强归当录径御忧怀态怜总恋恒恳'
    '恶恸恺恼悬悯惊惧惨惩惫惭惯愈愤愿懒戏战扎扑托执扩扪扫扬扰折抚抛抟抡抢护报抬抵担拟拢拣拥拦拧拨择挂挞挟'
    '挡挣挤损捡换捣据捻掳掷搀搁搂搅携摆摇撑撵攒敌敛数斋斗斩断无旧时旷昼显晋晒晓暂术朱朴机杀杂权杆杠条来杨'
    '杰松极构枢枪枫柜标栋栏树栖样桨梁梦检棂楼榄槛横橹欢欲残殓殡殴毁毁毂毕毙气汉汤汹沟没沦沧泛泞注泪泻泼洁'
    '洒洼浅浆浇浊测济浑浓涂涌涛涤润涨渊渎渐渔游湾湿溃溅滚满滤滥滨滩澜灭灯灵灾灿炉点炼烁烂烛烟烦烧烫热爱牵'
    '牺犊状犹独狭狮狱狸猎猪猫献玛环现玺珰琏琐璎瓮电画畅疖疟疮疯痒痨痪痫痴瘪瘫癣癫皱盏盐监盖盗盘睁瞒矶矿码'
    '砖确碍碜碱礼祷祸禀禄离秃种积称秽稣稳穑穷窃窍窑窜窝窥竖竞笃笔笼筑筛筹签签箩箫篓篮篱籴类粜粪粮系系紧红'
    '约级纪纬纯纲纳纵纶纷纸纹纺纽线练细织终绊经绑绒结绕给络绝统绣继续绰绳绵绸绺绿缄缅缆缒缓编缘缚缝缠缦缩'
    '网罗罚罢羁羡群耸耻聂聋职联聪肃肠肤肮肾肿胀胁胆胜胡胶脉脏脏脐脑脓脚脸腊腌腾致舍舱艰艳艺节芦苇苍苏苏苟'
    '苹范茔荆荐荚荡荡荣荤荫药莱莲获营萨蓝虑虚虫虽蚀蚁蚂蚕蛮蜗蜡蝇蝎衔补衮装裤见观规觅视觉觌觐触誉誊计订认'
    '讥讨让训议记讲讳讶讷许讹论讼设访诀证评诅识诈诉词诏译诓试诗诚话诡询该详诧诫诬语诮误诰诱诲说诵请诸诺读'
    '课诿谁调谄谅谆谈谊谋谎谏谒谕谗谜谢谣谤谦谨谬谱谷贝贞负贡财责贤败账货质贩贪贫贬贯贱贴贵贷贸费贺贻贼贾'
    '贿赀赁赂赃资赉赌赎赏赐赒赔赖赘赚赛赞赠赢赶趋跃践踊踪蹿车轧轨转轭轮软轰轴轻载轿较辅辆辇辈辉辋辎辐输辔'
    '辖辗辞辟辩辫边辽达迁过迈运还这进远违连迟迹迹适选逊递逻遗遥邻郑酿采释里鉴鉴錾针钉钏钓钝钢钥钦钩钮钱钹'
    '钻铁铃铅铊铙铛铜铠铭铮铲银铸铺链链销锁锄锅锈锈锉锋锐错锚锡锣锤锥锦锨锭锯锸锹镀镇镊镌镕镜镟镣镯镰镶长'
    '门闩闪闭问闯闲闲间闵闷闸闹闺闻阁阄阉阔队阳阴阵阶陆陇陈险随隐隶难雏雾霉静面韦顶顷项顺须须顽顾顿颁颂预'
    '领颈颊颗题颜额颠颤风飕飖飘飞餍饥饥饫饭饮饰饱饶饷饼饿馆馈馋馐馑马驮驯驰驱驳驴驹驻驼驾驿骂骄骆骇验骏骑'
...
const String kCuvTraditionalChars =
    '繸萬與醜專業叢東絲丟兩嚴喪個豐臨為麗舉麼義烏樂習鄉書買亂瞭爭於虧雲亙亞產畝親褻億僅僕從崙倉儀們價彷眾'
    '夥會偉傳傷倫偽體餘彿傭姪側藉債傾償兒剋黨蘭關興養獸內岡冊寫軍農沖衝決況淨淒悽準涼減湊幾鳳憑凱兇擊鑿劃'
    '則剛創刪別颳製劍剝勸辦務動勵勁勞勢勻區醫華協單賣佔鹵衞卻捲廠廳歷厲壓厭廁廚參雙發髮變敍疊隻臺葉號嘆歎'
    '籲閤弔後嚇呂嗎聽啓吳吶嘔員週嚨鹹響啞噠嘩喚嗇餵噴噯噓囑迴團園圍圇國圖圓聖場壞塊堅壇罈墳墜壘墾墊墮牆壯'
    '聲壺處備復覆複夠頭誇夾奪奩奮獎奧姦妝婦媽嬌孌嬰嬪孫學寧寶實寵審宮寬賓寢對尋導壽將爾塵嘗屍盡儘層屜屬屢'
    '歲豈嶇島巖嶺峯佈帥師帳簾幟帶幫乾幹並併廣莊慶牀庫應廟廢廩開異棄弒張彌彎彈強歸當錄徑禦憂懷態憐總戀恆懇'
    '惡慟愷惱懸憫驚懼慘懲憊慚慣癒憤願懶戲戰紮撲託執擴捫掃揚擾摺撫拋摶掄搶護報擡牴擔擬攏揀擁攔擰撥擇掛撻挾'
    '擋掙擠損撿換搗據撚擄擲攙擱摟攪攜擺搖撐攆攢敵斂數齋鬥斬斷無舊時曠晝顯晉曬曉暫術硃樸機殺雜權桿槓條來楊'
    '傑鬆極構樞槍楓櫃標棟欄樹棲樣槳樑夢檢欞樓欖檻橫櫓歡慾殘殮殯毆毀燬轂畢斃氣漢湯洶溝沒淪滄氾濘註淚瀉潑潔'
    '灑窪淺漿澆濁測濟渾濃塗湧濤滌潤漲淵瀆漸漁遊灣濕潰濺滾滿濾濫濱灘瀾滅燈靈災燦爐點煉爍爛燭煙煩燒燙熱愛牽'
    '犧犢狀猶獨狹獅獄貍獵豬貓獻瑪環現璽璫璉瑣瓔甕電畫暢癤瘧瘡瘋癢癆瘓癇癡癟癱癬癲皺盞鹽監蓋盜盤睜瞞磯礦碼'
    '磚確礙磣鹼禮禱禍稟祿離禿種積稱穢穌穩穡窮竊竅窯竄窩窺豎競篤筆籠築篩籌籤簽籮簫簍籃籬糴類糶糞糧繫係緊紅'
    '約級紀緯純綱納縱綸紛紙紋紡紐線練細織終絆經綁絨結繞給絡絕統繡繼續綽繩綿綢綹綠緘緬纜縋緩編緣縛縫纏縵縮'
    '網羅罰罷羈羨羣聳恥聶聾職聯聰肅腸膚骯腎腫脹脅膽勝鬍膠脈臟髒臍腦膿腳臉臘醃騰緻捨艙艱艷藝節蘆葦蒼蘇甦茍'
    '蘋範塋荊薦莢蕩盪榮葷蔭藥萊蓮獲營薩藍慮虛蟲雖蝕蟻螞蠶蠻蝸蠟蠅蠍銜補袞裝褲見觀規覓視覺覿覲觸譽謄計訂認'
    '譏討讓訓議記講諱訝訥許訛論訟設訪訣證評詛識詐訴詞詔譯誆試詩誠話詭詢該詳詫誡誣語誚誤誥誘誨説誦請諸諾讀'
    '課諉誰調諂諒諄談誼謀謊諫謁諭讒謎謝謠謗謙謹謬譜穀貝貞負貢財責賢敗賬貨質販貪貧貶貫賤貼貴貸貿費賀貽賊賈'
    '賄貲賃賂贓資賚賭贖賞賜賙賠賴贅賺賽讚贈贏趕趨躍踐踴蹤躥車軋軌轉軛輪軟轟軸輕載轎較輔輛輦輩輝輞輜輻輸轡'
    '轄輾辭闢辯辮邊遼達遷過邁運還這進遠違連遲蹟跡適選遜遞邏遺遙鄰鄭釀採釋裏鑒鑑鏨針釘釧釣鈍鋼鑰欽鈎鈕錢鈸'
    '鑽鐵鈴鉛鉈鐃鐺銅鎧銘錚鏟銀鑄鋪鏈鍊銷鎖鋤鍋鏽銹銼鋒鋭錯錨錫鑼錘錐錦杴錠鋸鍤鍬鍍鎮鑷鐫鎔鏡鏇鐐鐲鐮鑲長'
    '門閂閃閉問闖閒閑間閔悶閘鬧閨聞閣鬮閹闊隊陽陰陣階陸隴陳險隨隱隸難雛霧黴靜麵韋頂頃項順須鬚頑顧頓頒頌預'
    '領頸頰顆題顏額顛顫風颼颻飄飛饜饑飢飫飯飲飾飽饒餉餅餓館饋饞饈饉馬馱馴馳驅駁驢駒駐駝駕驛罵驕駱駭驗駿騎'
