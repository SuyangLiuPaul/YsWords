...
/// alignment this repo's data supports: 61 verse pairs differ in
/// nothing but stray spaces around a `<note:>` or a closing quote
/// (民数记 10:29 and 士师记 1:16 are two), so a raw length comparison
/// throws them away. Removing spaces first recovers all 61 and costs
...
///
/// 1,115 Han character pairs differ, over 1,111 distinct Simplified
...
/// drift from what the shipped text actually says.
///
...
/// its own copies of the same two assets. The files are not the same
...
///
/// 1,115 pairs over 1,111 distinct Simplified characters. Four
/// Simplified characters stand opposite two different Traditional ones
/// (发 → 發/髮, 坛 → 壇/罈, 干 → 乾/幹, 须 → 須/鬚), so they appear
...
const String kCuvSimplifiedChars =
    ...
    '删别制剑剥劝办务动励劲劳势匀区医华协单卖卤卧卫却厂厅历厉压厌厕厨参双发发变叙叠只台叶号叹吁后吓吕吗听启吴呐呕员咙咸响哑哒哗唤啬喂喷嗳嘘嘱团园围囵国图圆圣场坏块坚坛坛坟坠垒垦垫堕墙壮声壶处备复够头夸夹夺'
    '奁奋奖奥妆妇妈娇娈婴嫔孙学宁宝实宠审宫宽宾寝对寻导寿将尔尘尝尸尽层屉属屡岁岂岖岛岩岭岳帅师帐帘帜带帮干干并广庄庆库应庙废廪开异弃弑张弥弯弹强归当录径御志忧怀态怜总恋恒恳恶恸恺恼悦悬悯惊惧惨惩惫惭惯愈愤'
    '愿懒戏战户扎扑执扩扪扫扬扰抚抛抟抡抢护报抬担拟拢拣拥拦拧拨择挂挞挟挡挣挤损捡换捣据捻掳掷搀搁搂搅携摆摇撑撵攒敌敛数斋斗斩断无旧时旷昼显晋晒晓暂术朴机杀杂权杆条来杨杰松极构枢枪枫柜标栋栏树栖样桨梦检棂楼'
    '榄槛横橹欢残殓殡殴毁毂毕毙气汉汤汹沉沟没沦沧泞注泪泻泼洁洒洼浅浆浇浊测济浑浓涂涌涛涤润涨渊渎渐渔温游湾湿溃溅滚满滤滥滨滩澜灭灯灵灶灾灿炉点炼烁烂烛烟烦烧烫热爱牵牺犊状犹独狭狮狱狸猎猪猫献玛环现玺珰琏琐'
    '璎瓮电画畅疖疟疮疯痒痨痪痫痴瘪瘫癣癫皱盏盐监盖盗盘着睁瞒矶矿码砖确碍碜碱礼祷祸禀禄离秃种积称秸秽税稣稳穑穷窃窍窑窜窝窥竖竞笃笔笼筑筛筹签箩箫篓篮篱籴类粜粪粮紧红约级纪纬纯纲纳纵纶纷纸纹纺纽线练细织终绊'
    '经绑绒结绕给络绝统绣继续绰绳绵绸绺绿缄缅缆缒缓编缘缚缝缠缦缩网罗罚罢羁羡耸耻聂聋职联聪肃肠肤肮肾肿胀胁胆胜胡胶脉脏脐脑脓脚脱脸腊腌腾舱艰艳艺节芦芸苇苍苏苟苹范茔荆荐荚荡荣荤荫药莱莲获营萨葱蓝虑虚虫虽蚀'
    '蚁蚂蚕蛮蜗蜡蝇蝎衔补衮装裤见观规觅视觉觌觐触誉誊计订认讥讨让训议记讲讳讶讷许讹论讼设访诀证评诅识诈诉词诏译诓试诗诚话诡询该详诧诫诬语诮误诰诱诲说诵请诸诺读课诿谁调谄谅谆谈谊谋谎谏谒谕谗谜谢谣谤谦谨谬谱'
    '谷贝贞负贡财责贤败账货质贩贪贫贬贯贱贴贵贷贸费贺贻贼贾贿赀赁赂赃资赉赌赎赏赐赒赔赖赘赚赛赞赠赢赶趋跃践踊踪蹿车轧轨转轭轮软轰轴轻载轿较辅辆辇辈辉辊辋辎辐输辔辖辗辞辩辫边辽达迁过迈运还这进远违连迟迹适选'
...
const String kCuvTraditionalChars =
    ...
    '刪別製劍剝勸辦務動勵勁勞勢勻區醫華協單賣鹵臥衛卻廠廳歷厲壓厭廁廚參雙發髮變敘疊隻臺葉號嘆籲後嚇呂嗎聽啟吳吶嘔員嚨鹹響啞噠嘩喚嗇餵噴噯噓囑團園圍圇國圖圓聖場壞塊堅壇罈墳墜壘墾墊墮牆壯聲壺處備復夠頭誇夾奪'
    '奩奮獎奧妝婦媽嬌孌嬰嬪孫學寧寶實寵審宮寬賓寢對尋導壽將爾塵嘗屍盡層屜屬屢歲豈嶇島巖嶺嶽帥師帳簾幟帶幫乾幹並廣莊慶庫應廟廢廩開異棄弒張彌彎彈強歸當錄徑禦誌憂懷態憐總戀恆懇惡慟愷惱悅懸憫驚懼慘懲憊慚慣癒憤'
    '願懶戲戰戶紮撲執擴捫掃揚擾撫拋摶掄搶護報擡擔擬攏揀擁攔擰撥擇掛撻挾擋掙擠損撿換搗據撚擄擲攙擱摟攪攜擺搖撐攆攢敵斂數齋鬥斬斷無舊時曠晝顯晉曬曉暫術樸機殺雜權桿條來楊傑鬆極構樞槍楓櫃標棟欄樹棲樣槳夢檢欞樓'
    '欖檻橫櫓歡殘殮殯毆毀轂畢斃氣漢湯洶沈溝沒淪滄濘註淚瀉潑潔灑窪淺漿澆濁測濟渾濃塗湧濤滌潤漲淵瀆漸漁溫遊灣濕潰濺滾滿濾濫濱灘瀾滅燈靈竈災燦爐點煉爍爛燭煙煩燒燙熱愛牽犧犢狀猶獨狹獅獄貍獵豬貓獻瑪環現璽璫璉瑣'
    '瓔甕電畫暢癤瘧瘡瘋癢癆瘓癇癡癟癱癬癲皺盞鹽監蓋盜盤著睜瞞磯礦碼磚確礙磣鹼禮禱禍稟祿離禿種積稱稭穢稅穌穩穡窮竊竅窯竄窩窺豎競篤筆籠築篩籌簽籮簫簍籃籬糴類糶糞糧緊紅約級紀緯純綱納縱綸紛紙紋紡紐線練細織終絆'
    '經綁絨結繞給絡絕統繡繼續綽繩綿綢綹綠緘緬纜縋緩編緣縛縫纏縵縮網羅罰罷羈羨聳恥聶聾職聯聰肅腸膚骯腎腫脹脅膽勝鬍膠脈臟臍腦膿腳脫臉臘醃騰艙艱艷藝節蘆蕓葦蒼蘇茍蘋範塋荊薦莢蕩榮葷蔭藥萊蓮獲營薩蔥藍慮虛蟲雖蝕'
    '蟻螞蠶蠻蝸蠟蠅蠍銜補袞裝褲見觀規覓視覺覿覲觸譽謄計訂認譏討讓訓議記講諱訝訥許訛論訟設訪訣證評詛識詐訴詞詔譯誆試詩誠話詭詢該詳詫誡誣語誚誤誥誘誨說誦請諸諾讀課諉誰調諂諒諄談誼謀謊諫謁諭讒謎謝謠謗謙謹謬譜'
    '穀貝貞負貢財責賢敗賬貨質販貪貧貶貫賤貼貴貸貿費賀貽賊賈賄貲賃賂贓資賚賭贖賞賜賙賠賴贅賺賽讚贈贏趕趨躍踐踴蹤躥車軋軌轉軛輪軟轟軸輕載轎較輔輛輦輩輝輥輞輜輻輸轡轄輾辭辯辮邊遼達遷過邁運還這進遠違連遲跡適選'
...
/// segmented reading of a query. 的 is in 24,527 verses; asking for it
/// as a conjunct asks for nothing.
///
/// 雅 is in the list, and it is in it BECAUSE this edition spells the
/// divine name 雅伟 — 雅 is in 7,290 verses, which is 雅伟's 6,106 plus
...
const List<SearchSynonymGroup> kSearchSynonymGroups = [
  ...
  /// 基督 in 542 — which is also the group most likely to annoy: a
  /// reader looking for the two verses that say 弥赛亚 does not
  /// necessarily want the 542 that say 基督. It is in because the
